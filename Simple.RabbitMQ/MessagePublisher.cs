...
namespace Simple.RabbitMQ
{
    public class MessagePublisher : IMessagePublisher
    {
        ...
        /*
         * Constructor for the MessagePublisher class.
         *
         ...
         */
        public MessagePublisher(IBasicConnection basicConnection, string exchange, string exchangeType, int timeToLive = 30000)
        {
        ...
        /*
         * Disposes of the MessagePublisher object.
         */
        public void Dispose()
        {
            Dispose(true);
